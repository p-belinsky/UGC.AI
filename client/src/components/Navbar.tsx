...
export function Navbar() {
    ...
    return (
        ...
        >
            <div
                className='max-w-6xl mx-auto flex items-center justify-between bg-black/50 backdrop-blur-md border border-white/4 rounded-2xl p-3'>
                ...
                {!user ? (
                    <div className='hidden md:flex items-center gap-3'>
                        ...
                        <PrimaryButton onClick={() => openSignUp()} className='max-sm:text-xs hidden sm:inline-block'>Get
                            Started</PrimaryButton>
                    </div>
                ) : (
